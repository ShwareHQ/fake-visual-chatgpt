...
class ImageEditing:
    ...
    def inference_replace(self, inputs):
        ...
        cv2.imwrite(updated_image_path, np.zeros((64, 64)))
...
class Text2Image:
    ...
    @prompts(name="Generate Image From User Input Text",
             description="useful when you want to generate an image from a user input text and save it to a file. "
                         "like: generate an image of an object or something, or generate an image that includes some "
                         "objects."
    ...
    def inference(self, text):
        ...
        cv2.imwrite(image_filename, np.zeros((64, 64)))
...
class ImageCaptioning:
    ...
    def inference(self, image_path):
        captions = "give the user a random image caption"
...
class VisualQuestionAnswering:
    ...
    def inference(self, inputs):
        ...
        answer = "give the user a random answer"
...
class InfinityOutPainting:
    ...
    def __init__(self, ImageCaptioning, ImageEditing, VisualQuestionAnswering):
        ...
        print(f"Initializing InfinityOutPainting")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', type=str,
                        default="ImageEditing_cuda:0,InstructPix2Pix_cuda:0,Text2Image_cuda:0,ImageCaptioning_cuda:0,"
                                "Image2Canny_cuda:0,CannyText2Image_cuda:0,Image2Line_cuda:0,LineText2Image_cuda:0,"
                                "Image2Hed_cuda:0,HedText2Image_cuda:0,Image2Scribble_cuda:0,"
                                "ScribbleText2Image_cuda:0,Image2Pose_cuda:0,PoseText2Image_cuda:0,Image2Seg_cuda:0,"
                                "SegText2Image_cuda:0,Image2Depth_cuda:0,DepthText2Image_cuda:0,Image2Normal_cuda:0,"
                                "NormalText2Image_cuda:0,VisualQuestionAnswering_cuda:0")
    ...
    with gr.Blocks(css="#chatbot .overflow-y-auto{height:500px}") as demo:
        ...
        demo.launch(server_name="127.0.0.1", server_port=10100)
